...
function DragHandle({ onDrag }: { onDrag: (delta: number) => void }) {
  ...
  return (
    <div
      ...
      className="w-2 cursor-col-resize shrink-0 bg-zinc-800/50 hover:bg-brand/40 active:bg-brand/60 transition-colors duration-150"
    />
  );
}
    ...
    <div className="flex h-screen w-screen flex-col bg-zinc-950 text-zinc-100">
      <header className="flex h-12 items-center gap-3 border-b border-zinc-800 px-4">
        <button
          ...
          className="rounded p-1.5 text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800 transition-colors duration-150"
        ...
        <span className="font-mono text-sm font-semibold tracking-tight text-zinc-100">OBSIDIANA</span>
        ...
        {selectedPath ? (
          <>
            <button
              ...
              className="shrink-0 border-l border-zinc-800 px-1.5 text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800 flex items-center transition-colors duration-150"
            ...
            <div role="tablist" className="flex border-b border-zinc-800 text-xs">
              <button
                ...
                className={`flex-1 px-3 py-2 transition-colors duration-150 ${
                  rightTab === "tags"
                    ? "text-zinc-100 border-b-2 border-brand"
